...
class HandOppositionPage extends StatefulWidget {
  const HandOppositionPage({super.key});

  @override
  State<HandOppositionPage> createState() => _HandOppositionPageState();
}

class _HandOppositionPageState extends State<HandOppositionPage> {
